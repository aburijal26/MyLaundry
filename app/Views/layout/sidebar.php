    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item <?= ($current_uri == "pemesanan") ? "active" : "" ?>">
                    <a href="/pemesanan/create" class="collapsed" aria-expanded="false">
                        <i class="fas fa-list"></i>
                        <p>Pemesanan</p>
                    </a>
                </li>
                <li class="nav-item <?= ($current_uri == "pemesanan") ? "active" : "" ?>">
                    <a href="/pemesanan" class="collapsed" aria-expanded="false">
                        <i class="fas fa-list"></i>
                        <p>Lihat Pemesanan</p>
                    </a>
                </li>
                <li class="nav-item <?= ($current_uri == "pembayaran") ? "active" : "" ?>">
                    <a href="/pembayaran" class="collapsed" aria-expanded="false">
