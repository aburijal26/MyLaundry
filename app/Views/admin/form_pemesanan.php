                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <select name="IDPelanggan" id="IDPelanggan" class="form-control IDPelanggan" required>
                                                            <option value="" selected="selected">- Pilihan -</option>
                                                            <?php foreach ($pelanggan as $row) : ?>
                                                                <option <?= set_select("IDPelanggan", $row->IDPelanggan, TRUE) ?> value=<?= $row->IDPelanggan; ?>><?= $row->IDPelanggan . " | " . $row->NamaPelanggan; ?></option>;
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group form-group-default">
                                                        <label>Nama Lengkap</label>
                                                        <input type="text" class="form-control" name="NamaPemesan" id="NamaPemesan" placeholder="Nama Lengkap" value="" required readonly>
                                                    </div>
                                                    <div class="form-group form-group-default">
                                                        <label>Nomor Telepon</label>
                                                        <input type="number" class="form-control" name="NomorTlp" id="NomorTlp" placeholder="Nomor Telepon" value="" required readonly>
                                                    </div>
                                                    <div class="form-group form-group-default">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <select name="HargaDelivery" id="HargaDelivery" class="form-control" required>
                                                            <option value="">- Pilihan -</option>
                                                            <option value="5000">Antar (Rp 7.000)</option>
...
<script>
    $(document).ready(function() {
        $.ajax({
            url: '/pemesanan/search',
            data: "IDPelanggan=" + $(this).find(":selected").val(),
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                console.log(data);
                if (data !== 'error') {
                    $("#NamaPemesan").val(data.NamaPelanggan);
